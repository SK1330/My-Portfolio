...
// $('.frm').click(function(){
//   $('.frm').find("input[type=textarea], input[type=password], textarea").each(function(){
//     $(this).css({'color':'#ffc20b'})
//   });
// });

  // $('.frm[placehodler]').click(function(){
  //   ('.frm[placehodler]').css({'color':'#ffc20b'})
  // });
